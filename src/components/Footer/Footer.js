        ...
        <Box justifyContent="center" pb={6}>
            <Card className={classes.root}>
              <CardContent>
                ...
                <WhiteText align="center">Наша платформа лише у бета-версії. Якщо у тебе є ідеї як її покращити, хочеш приєднатись до команди або щось поламалось — напиши нам, будь ласка</WhiteText>
                  </Grid>
