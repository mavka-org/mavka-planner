...
let topics = [
    {title: "good heavens this can work", id: "43689"},
    {title: "gracious heavens this can work", id: "4368dsf9"}

];

let sample_program_json = require('../ProgramPage/sample_program_json.json')
console.log("sample_program_json ", sample_program_json)
...
for (const [index, topic] of loaded_program.topics.entries()) {
    topics.push({title: topic.name, id: topic.id})
}
